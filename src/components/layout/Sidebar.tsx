...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <div className="w-64 text-black flex flex-col" style={{ backgroundColor: '#FEF8F3' }}>
      <div className="p-4 border-gray-800 flex items-center">
        <div className="h-8 w-8 rounded-full bg-[#E7873C] mr-3 flex items-center justify-center">
      ...
      <div className="flex-grow overflow-y-auto">
        <ul className="py-4">
          <li 
            ...
            style={{ backgroundColor: activeTab === 'dashboard' ? '#E7873C ' : 'transparent' }}
          ...
          <li 
            className={`px-4 py-3 flex items-center cursor-pointer`}
            style={{ backgroundColor: activeTab === 'layout' ? '#E7873C ' : 'transparent' }}
          ...
          <li 
            className={`px-4 py-3 flex items-center cursor-pointer`}
            style={{ backgroundColor: activeTab === 'employees' ? '#E7873C ' : 'transparent' }}
          ...
          <li 
            className={`px-4 py-3 flex items-center cursor-pointer`}
            style={{ backgroundColor: activeTab === 'projects' ? '#E7873C ' : 'transparent' }}
      ...
      <div className="p-4 border-t border-gray-800">
        <div 
          className={`flex items-center mb-4 cursor-pointer ${activeTab === 'profile' ? 'bg-[#E7873C]' : 'hover:bg-[#E7873C]'} p-2 rounded`}
