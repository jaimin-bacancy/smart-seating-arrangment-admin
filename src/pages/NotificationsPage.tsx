...
const NotificationsPage: React.FC<NotificationsPageProps> = ({ isSidebar = false }) => {
  ...
  const handleGenerateSampleNotifications = () => {
    // This would be implemented in a real app
    console.log('Generating sample notifications');
  };

  return (
    <div className={isSidebar ? '' : 'p-6'}>
      <div className="flex justify-between items-center mb-6">
        {!isSidebar && <h2 className="text-2xl font-bold">Notifications</h2>}
      ...
      {/* Notifications list */}
      <div className={`${isSidebar ? '' : 'bg-white rounded-lg shadow'} overflow-hidden`}>
